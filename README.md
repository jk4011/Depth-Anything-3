...
The model architecture is defined in [`DepthAnything3Net`](depth_anything_3/model/da3.py), and specified with a Yaml config file located at [`depth_anything_3/configs`](depth_anything_3/configs). The input and output processing are handled by [`DepthAnything3`](depth_anything_3/api.py). To customize the model architecture, simply create a new config file (*e.g.*, `path/to/new/config`) as:
